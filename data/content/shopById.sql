SELECT [shop].shop_id,
      ...
      ,concat(round(geography::Point(@lat, @lng, 4326).STDistance(geography::Point(loc.latitude, loc.longitude, 4326))/1000,2),' กิโลเมตร') AS [desc]
      ,geography::Point(@lat, @lng, 4326).STDistance(geography::Point(loc.latitude, loc.longitude, 4326)) AS distance
