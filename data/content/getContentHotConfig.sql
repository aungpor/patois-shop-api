...
FROM [dbo].[patois_config_content_hot] cth WITH (NOLOCK) 
...
and ( ( @content_hot_type = 'EXCELLENT' and cth.content_hot_type = 'EXCELLENT' ) or cth.content_hot_type != 'EXCELLENT' ) --รวมร้านอร่อยเด็ด
and ( ( @content_hot_type = 'TELL' and cth.content_hot_type = 'TELL' ) or cth.content_hot_type != 'TELL' ) --ร้านอร่อยบอกต่อ
